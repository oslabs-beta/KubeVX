...
router.get('/getqueries', metricsDataController.allQueries, (req, res) => {
...
router.get('/logs', logsController.getLogs, (req, res) => {
  res.status(200).json(res.locals.logs);
});

router.get('/alerts', alertsController.fetchAlerts, (req, res) => {
